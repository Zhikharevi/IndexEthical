...
def main():
    ...
    org_type = "Центр планирования семьи"

    links_file_path = os.path.join(
        "Get_links_for_companies", "Links_for_diff_types_of_clinics", "moscow_family_planing_clinic_links.txt"
    )
    ...
    for idx, url in enumerate(links, 1):
        ...
        try:
            path_to_save_csv = "yandex_reviews_main_61k_last_right_version.csv"
